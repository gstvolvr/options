...
pub struct Returns {
    ...
    pub return_after_0_div: Option<f64>,
    ...
    pub return_after_last_div: Option<f64>,
    pub bid: f64,
    pub mid: f64,
    pub ask: f64,
...
impl Returns {
    ...
    pub fn to_csv_record(&self) -> Vec<String> {
        vec![
            ...
            self.return_after_0_div.map_or(String::new(), |v| v.to_string()),
            self.return_after_1_div.map_or(String::new(), |v| v.to_string()),
            self.return_after_2_div.map_or(String::new(), |v| v.to_string()),
            self.return_after_3_div.map_or(String::new(), |v| v.to_string()),
            self.return_after_4_div.map_or(String::new(), |v| v.to_string()),
            self.return_after_5_div.map_or(String::new(), |v| v.to_string()),
            self.return_after_last_div.map_or(String::new(), |v| v.to_string()),
            self.bid.to_string(),
            self.mid.to_string(),
            self.ask.to_string(),
